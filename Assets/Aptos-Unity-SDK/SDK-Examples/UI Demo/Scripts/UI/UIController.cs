...
namespace Aptos.Unity.Sample.UI
{
    public class UIController : MonoBehaviour
    {
        ...
        [SerializeField] private PanelTab rewardNFTTab;
        ...
        public void ClaimRewardNFT()
        {
            StartCoroutine(AptosUILink.Instance.ClaimRewardNFT());         
        }

        public void BuyPowerUp(int indexNo)
        {
            StartCoroutine(AptosUILink.Instance.BuyPowerUp(indexNo));
        }
