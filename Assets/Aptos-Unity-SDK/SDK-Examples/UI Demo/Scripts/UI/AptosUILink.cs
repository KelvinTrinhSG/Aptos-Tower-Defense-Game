...
namespace Aptos.Unity.Sample.UI
{
    public class AptosUILink : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            gameShopTab.gameObject.SetActive(false);
        }
        ...
        public TMPro.TextMeshProUGUI userRewardNFTBalance;
        public Button logInWithNFTButton;
        public Button playButton;

        public Button addAccountTab;
        public Button accountTab;
        public Button sendTransactionTab;
        public Button rewardNFTTab;
        public Button gameShopTab;

        public IEnumerator ClaimRewardNFT()
        {
            ...
            string collectionName = "Tower Defense Game";
            string collectionDescription = "Tower Defense Game collection";
            string collectionUri = "https://aptos.dev";

            string tokenName = "Tower Defense Game's GamePass Key";
            string tokenDescription = "GamePass Key for Playing Tower Defense Game";
            string tokenUri = "https://gateway.pinata.cloud/ipfs/QmYAodTD6Rye2XkWBBynpUhyNW6FFhZjZeDc9hSaBxf4XN";
            ...
            userRewardNFTBalance.text = "NFT Balance: " + getTokenBalanceResultBobBeforeClaim;
            ...
            if (float.Parse(getTokenBalanceResultBobBeforeClaim) >= 1f)
            {
                ...
                rewardNFTTab.interactable = true;
                gameShopTab.interactable = true;

                playButton.gameObject.SetActive(true);
                gameShopTab.gameObject.SetActive(true);
                logInWithNFTButton.gameObject.SetActive(false);
                addAccountTab.gameObject.SetActive(false);
                accountTab.gameObject.SetActive(false);
                sendTransactionTab.gameObject.SetActive(false);
        ...
        Debug.Log("<color=cyan>=== Get Token Balance for Alice NFT ===</color>");
            ...
            userRewardNFTBalance.text = "NFT Balance: " + getTokenBalanceResultBob;
        ...
        public TMPro.TextMeshProUGUI currentGoldText;
        public TMPro.TextMeshProUGUI buyingStatusText;
        public TMPro.TextMeshProUGUI resourceBoostText;
        public TMPro.TextMeshProUGUI currentWoodText;
        public TMPro.TextMeshProUGUI currentStoneText;

        public Button buyGoldButton;
        public Button buyx2ResourceButton;
        ...
        public IEnumerator BuyPowerUp(int indexNo)
        {
            ...
            buyGoldButton.interactable = false;
            buyx2ResourceButton.interactable = false;
            ...
            Coroutine transferCor = StartCoroutine(RestClient.Instance.Transfer((_transaction, _responseInfo) =>
            {
                ...
                responseInfo = _responseInfo;
            }, alice, bob.AccountAddress.ToString(), 1000000));
            ...
            buyGoldButton.interactable = true;
            buyx2ResourceButton.interactable = true;
            ...
            if (indexNo == 0)
            {
                ...
                buyingStatusText.text = "+100 Gold";
                currentGoldText.text = "Current Gold: " + "100";
                buyGoldButton.gameObject.SetActive(false);
                ResourceBoost.Instance.goldBoost = 100;
            }
            else if (indexNo == 1)
            {
                //Give Player x2Resource Here
                buyingStatusText.text = "+100 Resources";
                resourceBoostText.text = "Resources Boost: 100";
                buyx2ResourceButton.gameObject.SetActive(false);
                ResourceBoost.Instance.resourceBoost = 2;
            }
            else if (indexNo == 2)
            {
                //Give Player Wood Here
                buyingStatusText.text = "+500 Wood";
                currentWoodText.text = "Current Wood: " + "500";
                buyWoodButton.gameObject.SetActive(false);
                ResourceBoost.Instance.woodBoost = 500;
            }
            else if (indexNo == 3)
            {
                //Give Player Stone Here
                buyingStatusText.text = "+200 Stone";
                currentStoneText.text = "Current Stone: " + "200";
                buyStoneButton.gameObject.SetActive(false);
                ResourceBoost.Instance.stoneBoost = 200;
            }
